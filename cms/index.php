...
<body>
    <h1 align='center' style="margin: 15px; color:white;font-weight: bold;font-family:Copperplate, Papyrus, fantasy">BIT   COURIER   SERVICE</h1>
    <hr />
    <br><br>
    <h2 align='center' style="font-weight: bold;color:darkmagenta;font-family:Copperplate, Papyrus, fantasy">The Fastest Courier Service !!!</h2>
    <div>
        <h3><a href="admin/adminlogin.php" style="float: right; margin-right:40px; color:6A5ACD; margin-top:0px">Admin Login</a></h3>
    </div>
    <div class="container" style="margin-top: 60px; width:50%;">
        <div class="row">
            <div class="col-md-12">
                <h2 style="color: #008B8B;">Login</h2>
