...
<body>
    ...
    <tr style="background-color:lightpink;font-size:30px">
    ...
    <h3 align="center" style="margin-top:20px;"> Amount Payable as per the Weight of Courier :</h3>
    <div style="margin-left:45% ;margin-right:auto ;font-weight:bold;">
    <ol>
    <li>UPI : abcd@sbi.com</li>
    <li>GPay : 6362786223</li>
    <li>PhonePay : 3565656555</li>
    </ol>
    </div>
</body>
</html>